                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror"
                                    ...
                                    value="{{ isset($page) ? $page->slug : old('slug') }}" autocomplete="slug" required
                                    autofocus>
                                @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="body" class="form-control @error('body') is-invalid @enderror" name="body"
                                    rows="5">{{ isset($page) ? $page->body : old('body') }}</textarea>
                                @error('body')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" value="1" class="custom-control-input" id="status"
                                        name="status" @isset($page) {{ $page->status ? 'checked' : '' }} @endisset>
...
@push('js')
<script src="https://cdn.tiny.cloud/1/g1axuf87kmcxy93m2ynfmp3usxm3k0mrzcdmm62m0f3pfme3/tinymce/5/tinymce.min.js"
